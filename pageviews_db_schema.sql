...
CREATE TABLE `pageviews` (
  ...
  `real_user` varchar(256) DEFAULT NULL,
  `user` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`pageviews_key`),
  UNIQUE KEY `request_id_unq` (`id`),
  KEY `account_id_idx` (`account`),
  KEY `context_idx` (`context`,`context_type`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1 PACK_KEYS=1 ROW_FORMAT=COMPRESSED;
...
-- Dump completed on 2014-02-10 13:56:56
